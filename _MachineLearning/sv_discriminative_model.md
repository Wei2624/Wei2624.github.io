...
$$=\begin{bmatrix} \sum\limits_{k,h}^{M,N} B_{1k}A_{hk}C_{h1} + \sum\limits_{i,j}^{N,M} A_{ij}B_{j1}C_{1i}  & \dots & \sum\limits_{k,h}^{M,N} B_{Mk}A_{hk}C_{h1} + \sum\limits_{i,j}^{N,M} A_{ij}B_{jM}C_{1i}\\ \sum\limits_{k,h}^{M,N} B_{1k}A_{hk}C_{h2} + \sum\limits_{i,j}^{N,M} A_{ij}B_{j1}C_{2i} & \dots & \sum\limits_{k,h}^{M,N} B_{Mk}A_{hk}C_{h2} + \sum\limits_{i,j}^{N,M} A_{ij}B_{jM}C_{2i} \\ \vdots & \dots & \vdots \\ \sum\limits_{k,h}^{M,N} B_{1k}A_{hk}C_{hN} + \sum\limits_{i,j}^{N,M} A_{ij}B_{j1}C_{Ni} & \dots & \sum\limits_{k,h}^{M,N} B_{Mk}A_{hk}C_{hN} + \sum\limits_{i,j}^{N,M} A_{ij}B_{jM}C_{Ni} \end{bmatrix}$$
